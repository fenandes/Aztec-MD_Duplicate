const { proto, getContentType, jidDecode, downloadContentFromMessage } = require('@adiwajishing/baileys')
...
let m = message[type]if (type === 'buttonsMessage' || type === 'viewOnceMessageV2') {
...
const tipe = Object.keys(m.message)[0]m.type = tipe
...
} else if (quoted.quotedMessage['viewOnceMessageV2']) {m.quoted = {
type: 'view_once',
stanzaId: quoted.stanzaId,
participant: decodeJid(quoted.participant),
