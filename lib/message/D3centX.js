...
const extractNumbers = require('../../mangoes/myFunc.js');
const extractUrls = require('../../mangoes/myFunc.js');
const decodeJid = (jid) => {
...
function serialize(m, vorterx) {
    ...
    if (m.message) {
        ...
        m.numbers = vorterx.utils.extractNumbers(m.body)
        m.urls = vorterx.utils.extractUrls(m.body)
    }
    return m
}
