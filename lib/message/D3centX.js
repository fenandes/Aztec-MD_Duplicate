...
const downloadMedia = async (message) => {
  ...
  if (msg.message) {
    ...
    if (msg.type === proto.WebMessageInfo.MessageType.LOCATION) {
      console.log('Location Message:', msg.message.ephemeralMessage.message.locationMessage); 
      msg.lat = msg.message?.ephemeralMessage?.message?.locationMessage?.degreesLatitude;
      msg.lng = msg.message?.ephemeralMessage?.message?.locationMessage?.degreesLongitude;
    }
